...
public final class GTOItems {
    ...
    public static final ItemEntry<ComponentItem> HEAT_SINK = item("heat_sink", "散热片", ComponentItem::create)
            .onRegister(attach(new CoverPlaceBehavior(GTOCovers.HEAT_SINK)))
            .register();
