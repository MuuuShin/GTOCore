...
public final class GTOCovers {
    ...
    static final CoverDefinition HEAT_SINK = GTCovers.register("heat_sink", heatSink::new, new SimpleCoverRenderer(GTOCore.id("block/machines/vacuum_pump/overlay_top")));
