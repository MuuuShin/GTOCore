...
public final class GTORecipeTypes {
    ...
    private static final Consumer<GTRecipeBuilder> addFuelProperties = b -> PowerlessJetpack.FUELS.putIfAbsent(((RecipeBuilder) b).HU(-1).getFluidInputs().getFirst().inner, (int) (b.getDuration() * Math.abs(b.EUt())));
