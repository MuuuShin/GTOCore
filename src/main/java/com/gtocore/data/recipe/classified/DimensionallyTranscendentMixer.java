...
final class DimensionallyTranscendentMixer {
    ...
    public static void init() {
        ...
        DIMENSIONALLY_TRANSCENDENT_SHOCK_RECIPES.recipeBuilder("dimensionallytranscendentprosaiccatalyst")
                ...
                .outputFluids(GTOMaterials.DimensionallyTranscendentProsaicCatalyst, 1000)
                .EUt(503316480)
                .duration(400)
                .save();
        ...
        DIMENSIONALLY_TRANSCENDENT_SHOCK_RECIPES.recipeBuilder("dimensionallytranscendentstellarcatalyst")
                ...
                .outputFluids(GTOMaterials.DimensionallyTranscendentStellarCatalyst, 1000)
                .EUt(503316480)
                .duration(3200)
                .save();
        ...
        DIMENSIONALLY_TRANSCENDENT_SHOCK_RECIPES.recipeBuilder("chaos_plasma")
                ...
                .inputFluids(GTMaterials.UUMatter, 4000)
                .inputFluids(GTOMaterials.CosmicNeutronium, 2000)
        ...
        DIMENSIONALLY_TRANSCENDENT_SHOCK_RECIPES.recipeBuilder("dimensionallytranscendentexoticcatalyst")
                ...
                .outputFluids(GTOMaterials.DimensionallyTranscendentExoticCatalyst, 1000)
                .EUt(503316480)
                .duration(1600)
                .save();
        ...
        DIMENSIONALLY_TRANSCENDENT_SHOCK_RECIPES.recipeBuilder("not_found")
                ...
                .outputFluids(GTOMaterials.NotFoundMix, 11000)
                .EUt(31457280)
                .duration(2200)
                .save();
        ...
        DIMENSIONALLY_TRANSCENDENT_SHOCK_RECIPES.recipeBuilder("dimensionallytranscendentresplendentcatalyst")
                ...
                .outputFluids(GTOMaterials.DimensionallyTranscendentResplendentCatalyst, 1000)
                .EUt(503316480)
                .duration(800)
                .save();
        ...
        DIMENSIONALLY_TRANSCENDENT_SHOCK_RECIPES.recipeBuilder("exciteddtsc")
                .inputFluids(GTOMaterials.DimensionallyTranscendentStellarCatalyst, 10000)
                .inputFluids(GTOMaterials.ConcentrationMixingHyperFuel2, 1000)
                .inputFluids(GTOMaterials.HighEnergyQuarkGluon.getFluid(FluidStorageKeys.PLASMA, 1000))
                .outputFluids(GTOMaterials.ExcitedDtsc, 10000)
                .EUt(503316480)
                .duration(12000)
                .save();
        ...
        DIMENSIONALLY_TRANSCENDENT_SHOCK_RECIPES.recipeBuilder("primordialmatter")
                ...
                .outputFluids(GTOMaterials.PrimordialMatter, 1000)
                .EUt(2013265920)
                .duration(1200)
                .save();
        ...
        DIMENSIONALLY_TRANSCENDENT_SHOCK_RECIPES.recipeBuilder("noble_gas")
                ...
                .outputFluids(GTOMaterials.NobleGasMix, 6000)
                .EUt(31457280)
                .duration(1200)
                .save();
    }
