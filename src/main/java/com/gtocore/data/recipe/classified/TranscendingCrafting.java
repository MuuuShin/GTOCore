...
final class TranscendingCrafting {
    ...
    public static void init() {
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("draconium_dust")
                ...
                .outputItems(GTOItems.DRACONIUM_DIRT)
                .EUt(7864320)
                .duration(400)
                .save();
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("magnetohydrodynamically_constrained_star_matternugget")
                ...
                .inputItems(GTOItems.SOLAR_LIGHT_SPLITTER)
                .inputFluids(GTOMaterials.TranscendingMatter, 10000)
                .inputFluids(GTOMaterials.MagnetohydrodynamicallyConstrainedStarMatter, 16)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("small_magnetohydrodynamically_constrained_star_matter_dust")
                ...
                .inputItems(GTOItems.SOLAR_LIGHT_SPLITTER)
                .inputFluids(GTOMaterials.TranscendingMatter, 10000)
                .inputFluids(GTOMaterials.MagnetohydrodynamicallyConstrainedStarMatter, 36)
                .inputFluids(GTOMaterials.DimensionallyTranscendentResidue, 1000)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("liquid_starlight")
                ...
                .inputItems(Blocks.BLUE_ICE.asItem(), 64)
                .inputFluids(GTOMaterials.TranscendingMatter, 10000)
                .inputFluids(GTOMaterials.Starlight, 10000)
                .outputFluids(GTOMaterials.LiquidStarlight, 10000)
                .EUt(7864320)
                .duration(9600)
                .save();
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("magnetohydrodynamically_constrained_star_matteringot")
                ...
                .inputItems(GTOItems.SOLAR_LIGHT_SPLITTER)
                .inputFluids(GTOMaterials.TranscendingMatter, 10000)
                .inputFluids(GTOMaterials.MagnetohydrodynamicallyConstrainedStarMatter, 144)
                .inputFluids(GTOMaterials.DimensionallyTranscendentResidue, 1000)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("cosmic_fabric")
                ...
                .outputItems(GTOItems.COSMIC_FABRIC)
                .EUt(503316480)
                .duration(200)
                .save();
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("magnetohydrodynamically_constrained_star_matterrod")
                ...
                .inputItems(GTOItems.SOLAR_LIGHT_SPLITTER)
                .inputFluids(GTOMaterials.TranscendingMatter, 10000)
                .inputFluids(GTOMaterials.MagnetohydrodynamicallyConstrainedStarMatter, 72)
                .inputFluids(GTOMaterials.DimensionallyTranscendentResidue, 1000)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("echoite_plasma")
                ...
                .inputFluids(GTOMaterials.TranscendingMatter, 16000)
                .inputFluids(GTOMaterials.Enderium, 1152)
                .inputFluids(GTOMaterials.Infuscolium, 1152)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("sculk_catalyst")
                ...
                .inputFluids(GTOMaterials.TranscendingMatter, 1000)
                .inputFluids(GTMaterials.EchoShard, 100)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("magnetohydrodynamically_constrained_star_matterframe")
                ...
                .inputItems(GTOItems.SOLAR_LIGHT_SPLITTER)
                .inputFluids(GTOMaterials.TranscendingMatter, 10000)
                .inputFluids(GTOMaterials.MagnetohydrodynamicallyConstrainedStarMatter, 288)
                .inputFluids(GTOMaterials.DimensionallyTranscendentResidue, 1000)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("magmatter_ingot")
                ...
                .inputFluids(GTOMaterials.Magmatter, 100)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("magnetohydrodynamically_constrained_star_matterblock")
                ...
                .inputItems(GTOItems.SOLAR_LIGHT_SPLITTER)
                .inputFluids(GTOMaterials.TranscendingMatter, 10000)
                .inputFluids(GTOMaterials.MagnetohydrodynamicallyConstrainedStarMatter, 1296)
                .inputFluids(GTOMaterials.DimensionallyTranscendentResidue, 1000)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("magmatter_ingot_d")
                ...
                .inputItems(TagPrefix.ingot, GTOMaterials.EnergeticNetherite)
                .inputFluids(GTOMaterials.TranscendingMatter, 10000)
                .inputFluids(GTOMaterials.Magmatter, 10)
                .outputItems(TagPrefix.ingot, GTOMaterials.Magmatter)
                .EUt(8053063680L)
                .duration(200)
                .save();
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("photocoated_hassium_boule")
                .inputItems(GTOItems.HIGH_PURITY_SINGLE_CRYSTAL_SILICON)
                .inputItems(TagPrefix.ingot, GTMaterials.Hassium, 2)
                .inputItems(GTOItems.HASSIUM_SEED_CRYSTAL)
                .inputFluids(GTOMaterials.TranscendingMatter, 10000)
                .inputFluids(GTOMaterials.WoodsGlass, 2304)
                .inputFluids(GTOMaterials.Photopolymer, 2000)
                .outputItems(GTOItems.PHOTOCOATED_HASSIUM_BOULE)
                .EUt(7864320)
                .duration(1000)
                .save();
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("bedrock_dust")
                ...
                .inputItems(TagPrefix.dust, GTOMaterials.CompressedStone, 64)
                .inputFluids(GTOMaterials.TranscendingMatter, 100000)
                .inputFluids(GTMaterials.Thulium, 9216)
                .inputFluids(GTMaterials.Copernicium, 9216)
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("dragon_stem_cells")
                ...
                .inputFluids(GTOMaterials.EnrichedDragonBreath, 100)
                .outputItems(GTOItems.DRAGON_STEM_CELLS)
                .EUt(7864320)
                .duration(400)
                .save();
        ...
        TRANSCENDING_CRAFTING_RECIPES.recipeBuilder("dragon_breath")
                ...
                .inputFluids(GTOMaterials.TranscendingMatter, 1000)
                .inputFluids(GTOMaterials.DragonBlood, 10)
