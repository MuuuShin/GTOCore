...
final class CircuitAssembler {
    ...
    public static void init() {
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("exotic_processor")
                ...
                .inputItems(GTOItems.EXOTIC_RAM_CHIP, 4)
                .inputItems(GTItems.HIGHLY_ADVANCED_SOC)
                .inputItems(GTOItems.SMD_CAPACITOR_EXOTIC, 8)
                .inputItems(GTOItems.SMD_TRANSISTOR_EXOTIC, 8)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("bioware_processor")
                .inputItems(GTOItems.BIOWARE_PROCESSING_CORE)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("supracausal_processor")
                ...
                .inputItems(GTOItems.SUPRACAUSAL_RAM_CHIP, 4)
                .inputItems(GTOItems.COSMIC_PROCESSING_UNIT_CORE, 16)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("magneto_resonatic_circuit_mv")
                .inputItems(GTItems.DIODE, 8)
                .inputItems(GTItems.CAPACITOR, 8)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("magneto_resonatic_circuit_lv")
                ...
                .inputItems(GTItems.CAPACITOR, 4)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("magneto_resonatic_circuit_ev")
                .inputItems(GTItems.SMD_DIODE, 8)
                .inputItems(GTItems.SMD_CAPACITOR, 8)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("magneto_resonatic_circuit_iv")
                .inputItems(GTItems.ADVANCED_SMD_DIODE, 4)
                .inputItems(GTItems.ADVANCED_SMD_CAPACITOR, 4)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("magneto_resonatic_circuit_hv")
                .inputItems(GTItems.SMD_DIODE, 4)
                .inputItems(GTItems.SMD_CAPACITOR, 4)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("hui_circuit_1")
                ...
                .inputItems(GTItems.SYSTEM_ON_CHIP, 8)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("bioware_circuit_board")
                .inputItems(GTItems.WETWARE_BOARD, 32)
                .inputItems(GTOItems.ELECTRICALY_WIRED_PETRI_DISH, 8)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("cosmic_processor")
                .inputItems(GTOItems.COSMIC_PROCESSING_CORE)
                .inputItems(GTOItems.COSMIC_RAM_CHIP, 4)
                .inputItems(GTItems.HIGHLY_ADVANCED_SOC)
                .inputItems(GTOItems.SMD_CAPACITOR_COSMIC, 16)
                .inputItems(GTOItems.SMD_TRANSISTOR_COSMIC, 16)
                .inputItems(TagPrefix.wireFine, GTOMaterials.Cinobite, 16)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("optical_processor")
                .inputItems(GTOItems.OPTICAL_PROCESSING_CORE)
                .inputItems(GTOItems.OPTICAL_RAM_CHIP, 4)
                .inputItems(GTItems.HIGHLY_ADVANCED_SOC)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder("planet_data_chip")
                ...
                .inputItems(GTItems.SIMPLE_SYSTEM_ON_CHIP, 12)
                ...
                .outputItems(GTOItems.PLANET_DATA_CHIP)
                .EUt(120)
                .duration(400)
                .save();
