...
final class Blast {
    ...
    public static void init() {
        ...
        BLAST_RECIPES.recipeBuilder("alumina_ceramic")
                ...
                .inputFluids(GTMaterials.Nitrogen, 500)
                .EUt(120)
                .duration(600)
        ...
        BLAST_RECIPES.recipeBuilder("hot_draconium_ingot_1")
                ...
                .inputFluids(GTMaterials.CetaneBoostedDiesel, 2000)
        ...
        BLAST_RECIPES.recipeBuilder("hot_draconium_ingot_3")
                .inputItems(TagPrefix.dust, GTOMaterials.Draconium)
                .inputFluids(GTMaterials.HighOctaneGasoline, 500)
                .outputItems(TagPrefix.ingotHot, GTOMaterials.Draconium)
                .EUt(125829120)
                .duration(200)
                .blastFurnaceTemp(21600)
        ...
        BLAST_RECIPES.recipeBuilder("hot_draconium_ingot_2")
                .inputItems(TagPrefix.dust, GTOMaterials.Draconium)
                .inputFluids(GTMaterials.Gasoline, 1000)
                .outputItems(TagPrefix.ingotHot, GTOMaterials.Draconium)
                .EUt(125829120)
                .duration(400)
                .blastFurnaceTemp(21600)
        ...
        BLAST_RECIPES.recipeBuilder("ostrum_ingot")
                ...
                .inputFluids(GTMaterials.SamariumIronArsenicOxide, 144)
        ...
        BLAST_RECIPES.recipeBuilder("calorite_ingot")
                ...
                .inputFluids(GTMaterials.Naquadah, 144)
        ...
        BLAST_RECIPES.recipeBuilder("giga_chad")
                .inputItems(GTItems.FIELD_GENERATOR_UIV, 64)
                .inputItems(GTItems.FIELD_GENERATOR_UXV, 64)
                .inputItems(GTItems.FIELD_GENERATOR_OpV, 64)
                .inputFluids(GTOMaterials.ExcitedDtec, 10000000)
                .outputItems(GTOItems.GIGA_CHAD)
                .EUt(2013265920)
                .duration(4000)
        ...
        BLAST_RECIPES.recipeBuilder("bedrock_smoke")
                ...
                .inputFluids(GTMaterials.Xenon, 100)
                .outputFluids(GTOMaterials.BedrockSmoke, 1000)
                .EUt(7864320)
                .duration(400)
