...
final class ArcFurnace {
    ...
    public static void init() {
        ARC_FURNACE_RECIPES.recipeBuilder("warped_ender_pearl")
                ...
                .outputItems(GTOItems.WARPED_ENDER_PEARL)
        ...
        ARC_FURNACE_RECIPES.recipeBuilder("anthracene")
                ...
                .inputFluids(Oxygen, 400)
                .outputFluids(GTOMaterials.Anthracene, 100)
                .EUt(120)
                .duration(400)
                .save();
        ...
        ARC_FURNACE_RECIPES.recipeBuilder("cosmic_singularity")
                ...
                .inputFluids(GTOMaterials.MagnetohydrodynamicallyConstrainedStarMatter, 9216)
                .outputItems(GTOItems.COSMIC_SINGULARITY)
