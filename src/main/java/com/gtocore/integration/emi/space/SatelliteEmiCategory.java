...
public class SatelliteEmiCategory extends EmiRecipeCategory {
    ...
    public static void register(EmiRegistry registry) {
        ...
        for (var entry : SatelliteControlCenterMachine.getPlanets()) {
            ...
            registry.addRecipe(SatelliteEmiRecipe.fromInputOutput(GTOCore.id("gtocoresatellite").withSuffix("/launch_satellite/" + entry.getKey()), b -> b.inputItems(SatelliteControlCenterMachine.getRocket(entry.getTier()))
